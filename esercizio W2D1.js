...
for (let i = 0; i <= 15; i++) {
  if (i % 2 === 0) {
    //se il resto della divisione è uguale a 0
    console.log(i, " Numero pari");
  } else console.log(i, " Numero dispari");
}
...
if (
  ...
  console.log("Condizione si è verificata");
}
...
let isMale = true;
let gender = isMale ? "male" : "female"; //se isMale è true metti male se no metti female
